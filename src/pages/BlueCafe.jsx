    ...
    <div>
      ...
      <div className="BlueCafeTimings">
        ...
        <div className="BlueCafeNourishment">
          ...
          <p>
            Offering a delicious range of snacks and refreshments, the café
            features stunning views of the Blue Lagoon.
          </p>
      ...
      <div className="BlueCafeBreakfast">
        ...
        <div className="BlueCafeBreakfastBox">
          <h2>Breakfast box</h2>
          <p>
            Enjoy our savory breakfast. You can get your meal in an eco-friendly
            takeaway box or dine in. The box includes a bagel, fresh fruits,
            juice, coffee, and a muffin, all for ISK 4,900. Pick up your box at
            Blue Café. Groups can pre-book takeaway boxes.
          </p>
        </div>
      </div>
    </div>
