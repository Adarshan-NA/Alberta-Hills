  ...
  return (
    <div className="RetreatHotel-BackgroundColor">
      ...
      <div className="RetreatHotel">
        ...
        <p className="RetreatHotel-Subtitle">
      ...
      <div className="RetreatHotel-Container">
        ...
        <div className="RetreatHotel-landmark">
          ...
          <p className="RetreatHotel-landmark_Subtitle">
            Covering 2300 square meters and surrounded by the Retreat Lagoon,
            this subterranean sanctuary embodies the inspiring interplay of
            nature, design, and the radiant powers of geothermal seawater.
            Encompassing multiple experience areas, the spa journey culminates
            with the Blue Lagoon Ritual, bringing you into harmony with the
            nourishing wonders of the volcanic earth.
          </p>
