    ...
    <div className="RetreatHotel-BackgroundColor">
      ...
      <div className="RetreatHotel-Container">
        ...
        <div className="RetreatHotel-landmark">
          <h2 className="RetreatHotel-landmark_Title">
            {" "}
            A landmark of luxury in a landscape of wonder
          </h2>
          <p className="RetreatHotel-landmark_Subtitle">
            The Retreat at Blue Lagoon is an award-winning luxury resort
            encompassing a 60-suite hotel, a subterranean spa, Michelin-starred
            dining, and a private lagoon sourced from the same healing waters as
            the Blue Lagoon.
          </p>
