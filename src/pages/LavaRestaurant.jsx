...
const starters=[
    {id:1, dishName:"Mushroom soup",ingredients:"Shiitake mushrooms, oyster mushrooms, cream", price:"30 CAD" },
    {id:2, dishName:"Baked Golden and Ruby Beets",ingredients:"lettuce, radish, chickpeas", price:"25 CAD" },
    {id:3, dishName:"Langoustine Soup",ingredients:"garlic-marinated langoustine, dulse", price:"35 CAD" },
    {id:4, dishName:"Chicken liver parfait",ingredients:"blueberries, crispy bread, bacon", price:"45 CAD" },
    {id:5, dishName:"Arctic char",ingredients:"cucumber, rye bread, greek yogurt", price:"35 CAD" }
]

const MainDish=[
    {id:1, dishName:"Grilled Cauliflower",ingredients:"Tomatoes, grapes, quinoa", price:"50 CAD" },
    {id:2, dishName:"COD",ingredients:"apples, mashed potatoes, shellfish sauce, fennel", price:"65 CAD" },
    {id:3, dishName:"Fish of the day",ingredients:"potatoes, broccolini, dates, shellfish sauce", price:"65 CAD" },
    {id:4, dishName:"Lamb Fillet",ingredients:"potatoes, parsnip, carrots", price:"75 CAD" },
    {id:5, dishName:"Grilled Beef",ingredients:"asparagus, sweet potatoes, kale", price:"90 CAD" }
]

const Dessert=[
    {id:1, dishName:"Crème Brûlée",ingredients:"vanilla, orange, almonds", price:"30 CAD" },
    {id:2, dishName:"Skyr Ganache",ingredients:"blueberries, toffee, cacao", price:"30 CAD" },
    {id:3, dishName:"Ástarpungar and Caramel",ingredients:"mango chocolate mousse, vanilla ice cream", price:"30 CAD" },
    {id:4, dishName:"Vegan Lemon Mousse",ingredients:"strawberries, soup, oats", price:"30 CAD" }
]
    ...
    return(
        <div className="LavaBody">
            ...
            <div className="StarterMenuImage">
                ...
                <img className="MenuRightImage" src={MainDishRightImage} alt="Title" /> 
                </div>
